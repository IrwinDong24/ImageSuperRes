...
file_path = './wind/ws_80m_2020_01_05days.nc'
...
for i in range(240):
    ...
    imgsx512 = []
    for j in range(7):
        imgsx512.append(data['windspeed_80m'][time_index, 50:562, j*73:512+j*73])
        imgsx512.append(data['windspeed_80m'][time_index, 100:612, j * 73:512 + j * 73])
    ...
    for j in range(7):
        for k in range(2):
            imgsx128.append(data['windspeed_80m'][time_index, 198+128*k:326+128*k, 256+50*j:384+50*j])
